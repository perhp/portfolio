...
export const industries: IndustryPage[] = [
  {
    ...
    title: "Fintech Web Developer | Accounting & Bookkeeping Software",
    description:
      "Senior freelance developer for fintech and accounting products. Six years on Visma Dinero, bookkeeping automation for e-commerce, React, Next.js, Node.js and TypeScript. Numbers that have to be right.",
  ...
  },
  {
    ...
    title: "Climate Tech Software Developer | LCA Tools & Carbon Data",
    description:
      "Freelance full-stack developer for climate tech. Two years and counting building an LCA screening tool and internal tooling for Målbar. Next.js, Node.js, TypeScript and data-heavy UIs.",
  ...
  },
  {
    ...
    title: "Biotech & Pharma Web Developer | Regulated Environments",
    description:
      "Senior freelance full-stack developer with three years building web solutions for Y-mAbs Therapeutics, a commercial-stage biopharma company. Reliability, correctness and documentation as standard.",
  ...
  },
  {
    ...
    title: "SaaS Developer for Hire | Senior Full-Stack, Next.js",
    description:
      "Senior freelance SaaS developer. Six years inside a large accounting SaaS, two years growing an LCA product, and my own booking SaaS. Next.js, React, Node.js and TypeScript, with someone who stays.",
  ...
  },
  {
    ...
    title: "E-commerce Developer | Webshop Tools, Payments, Integrations",
    description:
      "Freelance full-stack developer for e-commerce companies and the tools around them. Webshop data, order integrations, bookkeeping automation and payments in React, Next.js and Node.js.",
